...
const Project = () => {
      ...
      receiveMessage("project-message", (data) => {
        ...
        if (data.sender?._id === "ai") {
          try {
            ...
            // Still display the message even if parsing fails
            setMessages((prevMessages) => [...prevMessages, data]);

            // For debugging, log the problematic message
            console.log("Raw message that failed to parse:", data.message);
          }
        } else {
          setMessages((prevMessages) => [...prevMessages, data]);
        }
  ...
  const getFileContents = (file) => {
    if (!fileTree[file] || !fileTree[file].file || !fileTree[file].file.contents) {
      return "";
    }
